...
function parenthesize(tokens, list) {
    if (list === undefined) {
    ...
    if (token === '[') {
        ...
        list.push({ type: 'vector', value: subVector.value || [subVector] });
        return parenthesize(tokens, list);
    }
    if (token === ']') {
    ...
    list.push((0, Categorize_1.categorize)(token));
    return parenthesize(tokens, list);
}
//# sourceMappingURL=Parenthesize.js.map